...
export default function FundRecommendationPage() {
  ...
  // 卡片選中狀態管理
  const [selectedCard, setSelectedCard] = useState<'analysis' | 'performance' | 'risk' | 'strategy'>('analysis');
  ...
  // 卡片配置
  const cards = [
    { id: 'analysis', title: '市場分析' },
    { id: 'performance', title: '績效報告' },
    { id: 'risk', title: '風險評估' },
    { id: 'strategy', title: '投資策略' },
  ];
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      uploadFormData.append('category', 'fund-recommendation');
              ...
              <div className="flex flex-col gap-6">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">基金投資相關文件管理系統</p>
                  </div>
                </div>
                              ...
                              <tr key={document.id} className="border-b border-gray-100 hover:bg-gray-50">
                                ...
                                <td className="py-3 px-4 text-gray-700 text-sm">
                                  <button
                                    ...
                                    className="inline-flex items-center gap-1 px-3 py-1 bg-blue-100 text-blue-800 rounded-md hover:bg-blue-200 transition-colors text-xs"
                                  >
