...
export default function RealEstatePage() {
  ...
  // 卡片選中狀態管理
  const [selectedCard, setSelectedCard] = useState<'contract' | 'lease' | 'legal' | 'valuation'>('contract');
  ...
  // 卡片配置
  const cards = [
    { id: 'contract', title: '買賣合約' },
    { id: 'lease', title: '租賃文件' },
    { id: 'legal', title: '法規文件' },
    { id: 'valuation', title: '估價報告' },
  ];
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      uploadFormData.append('category', 'real-estate');
              ...
              <div className="flex flex-col gap-6">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">房地產相關文件管理系統</p>
                  </div>
                </div>
                  ...
                  {cards.map((card) => (
                    ...
                    <div className="flex items-center justify-center h-full">
                        <h3 className={`text-lg font-semibold ${
                          selectedCard === card.id ? 'text-green-900' : 'text-gray-900'
                        }`}>
                          {card.title}
                        </h3>
                      </div>
