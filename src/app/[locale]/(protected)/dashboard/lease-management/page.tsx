...
export default function LeaseManagementPage() {
  ...
  // 卡片選中狀態管理
  const [selectedCard, setSelectedCard] = useState<'contract' | 'maintenance' | 'finance' | 'inspection'>('contract');
  ...
  // 卡片配置
  const cards = [
    { id: 'contract', title: '租賃合約' },
    { id: 'maintenance', title: '維護管理' },
    { id: 'finance', title: '財務管理' },
    { id: 'inspection', title: '檢查報告' },
  ];
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      uploadFormData.append('category', 'lease-management');
