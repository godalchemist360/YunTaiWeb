...
export default function InsurancePage() {
  ...
  // 卡片選中狀態管理
  const [selectedCard, setSelectedCard] = useState<'policy' | 'claim' | 'product' | 'consultation'>('policy');
  ...
  // 卡片配置
  const cards = [
    { id: 'policy', title: '保單文件' },
    { id: 'claim', title: '理賠流程' },
    { id: 'product', title: '產品介紹' },
    { id: 'consultation', title: '諮詢服務' },
  ];
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      uploadFormData.append('category', 'insurance');
              ...
              <div className="flex flex-col gap-6">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">保險相關文件管理系統</p>
                  </div>
                </div>
                    ...
                    >
                      <div className="flex items-center justify-center h-full">
                        <h3 className={`text-lg font-semibold ${
                          selectedCard === card.id ? 'text-orange-900' : 'text-gray-900'
                        }`}>
                          {card.title}
                        </h3>
                      </div>
                              ...
                              <tr key={document.id} className="border-b border-gray-100 hover:bg-gray-50">
                                ...
                                <td className="py-3 px-4 text-gray-700 text-sm">
                                  <button
                                    ...
                                    className="inline-flex items-center gap-1 px-3 py-1 bg-orange-100 text-orange-800 rounded-md hover:bg-orange-200 transition-colors text-xs"
                                  >
