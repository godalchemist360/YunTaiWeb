...
async function insertTestAnnouncements() {
  try {
    ...
    const announcements = [
      {
        title: '系統維護通知',
        content:
          '系統將進行例行維護，期間可能會有短暫的服務中斷，請提前做好準備。維護期間將無法訪問系統功能，建議提前完成重要操作。',
        type: 'important',
        is_important: true,
      ...
      },
      {
        title: '建案資源',
        content:
          '新增多個優質建案資源，包含住宅、商業地產等多種類型。所有建案均經過嚴格篩選，提供詳細的項目資訊、價格分析和投資回報評估，協助您為客戶提供最佳的投資建議。',
        type: 'resource',
        is_important: false,
      ...
      },
      {
        title: '培訓課程安排',
        content:
          '新系統操作培訓課程將於下週舉行，請各位同仁準時參加。課程將涵蓋系統新功能的使用方法和最佳實踐。',
        type: 'training',
        is_important: false,
      ...
      },
      {
        title: '客戶資料更新',
        content:
          '客戶資料庫已進行全面更新，新增多項重要功能。請各位業務同仁及時查看並熟悉新功能，以提升客戶服務品質。',
        type: 'general',
        is_important: true,
      ...
      },
      {
        title: '銷售獎勵方案',
        content:
          '2024年第一季銷售獎勵方案已正式啟動，包含多項激勵措施和獎金制度。詳細內容請查看附件，如有疑問請聯繫管理部門。',
        type: 'resource',
        is_important: false,
    ...
    for (const announcement of announcements) {
      ...
      console.log(
        `已插入公告: ${announcement.title} (ID: ${result.rows[0].id})`
      );
    }
